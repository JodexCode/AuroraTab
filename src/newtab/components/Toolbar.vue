  ...
  <div class="toolbar-container" :style="toolbarStyle">
    <transition :name="direction === 'up' ? 'slide-up' : 'slide-side'">
      <div v-if="isToolbarOpen" class="toolbar-actions" :style="actionsStyle">
        <ToolButton :title="t('toolbar.appearance')" @click="emit('open-appearance')">
        ...
        <ToolButton :title="t('toolbar.language')" @click="emit('open-language')">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
            <path
              fill="currentColor"
        ...
        <ToolButton :title="t('toolbar.settings')" @click="emit('open-settings')">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
            <path
              fill="currentColor"
        ...
        <ToolButton :title="t('toolbar.wallpaper')" @click="emit('open-wallpaper')">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
            <path
              fill="currentColor"
